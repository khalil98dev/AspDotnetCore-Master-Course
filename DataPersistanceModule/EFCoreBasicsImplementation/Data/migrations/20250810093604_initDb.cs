...
namespace EFCoreBasicsImplementation.Data.Migrations
{
    /// <inheritdoc />
    public partial class initDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("c30d9647-1603-4948-8266-88a850547be0"), new Guid("2779ee47-10b0-4bd7-8342-404006aa1392"), "Sarah Peter", (short)3 },
                    { new Guid("ddd4e07a-4772-47f7-9cba-6bfc07c26bfe"), new Guid("2779ee47-10b0-4bd7-8342-404006aa1392"), "John Doe", (short)4 }
                });
